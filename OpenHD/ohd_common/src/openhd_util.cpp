...
std::optional<std::string> OHDUtil::run_command_out(const std::string& command, const bool debug) {
...
std::string OHDUtil::string_in_between(const std::string& start, const std::string& end, const std::string& value, bool debug) {
...
std::vector<std::string> OHDUtil::split_into_substrings(const std::string& input, const char separator) {
...
std::vector<std::string> OHDUtil::split_string_by_newline(const std::string& str, const bool include_newline_character) {
...
std::string OHDUtil::create_string_from_lines(const std::vector<std::string>& lines) {
    std::stringstream ss;
