...
class WBLink : public OHDLink {
   ...
   private:
    ...
    std::atomic<int> m_last_received_packet_ts_ms = openhd::util::steady_clock_time_epoch_ms();
    ...
    std::chrono::steady_clock::time_point m_thermal_protection_enable_tp = std::chrono::steady_clock::now();
